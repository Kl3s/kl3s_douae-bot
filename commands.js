...
mek = mek.messages[0]
      ...
      case 'alive':
		...
		await conn.sendMessage(from , { audio : fs.readFileSync("./src/alive.mpeg") , mimetype : 'audio/mpeg' , ptt: true  } , { quoted: mek })
              var alivemsg = ''
              if (config.ALIVEMSG == 'default') alivemsg = 'im in your job man \n klasster \n douae'
 ...
 //_______________________________________________________________________________________________________________________________________________________   //      
        ...
        case 'stic' :
          ...
          const cstic = await conn.sendMessage(from , { text: 'جاري صناعة الملصق' }, { quoted: mek } )
         ...
         await conn.sendMessage(from, { delete: cstic.key })
	       ...
	       v.reply('أين هي الصورة او الفيديو الذي تود ان تحوله للملصق ')
        }
              break 
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
	      ...
	      case "mfire" : 
		try {
		if (!q) return await conn.sendMessage(from , { text: 'أين هو رابط الميديافاير الدي تود تحميله ' }, { quoted: mek } )
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
	      ...
	      case "instagram" : 
		try {
		if (!q) return await conn.sendMessage(from , { text: 'أين هو رابط فيديو انستغرام الدي تود تحميله  ' }, { quoted: mek } )
...
╰────────────────────╯
  ...
  // _ _ _ _ _ _ _ _ __  _ _ _ _ _ _  __  _ _ _ __ _  __ _  _ _ _ _ __ _ _  __  __ _  _ __  _ __ _ _ _  _ __ _  _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ __  __ _  __ _ _ _ _   //   		      
		...
		const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'END:VCARD'
 await conn.sendMessage(from,{ contacts: { displayName: '' , contacts: [{ vcard }]  }} , { quoted: mek })      
		      break 
 //_______________________________________________________________________________________________________________________________________________________   //		      
