...
module.exports = {
    ...
    URL_1LINK: process.env.URL_1LINK === undefined ? 'http://instagram.com/kl3st_4' : process.env.URL_1LINK,
    ...
    FOOTER: process.env.FOOTER === undefined ? 'Kls@douae  instagram.com/kl3st_4 تابعني على الانستغرام ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? 'KLS-bot' : process.env.CAPTION,
    ...
    STIC_WM:process.env.STIC_WM === undefined ? 'BOT-Douae' : process.env.STIC_WM,
};
